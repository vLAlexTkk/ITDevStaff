...
export default function ArticleDetails({ params }: { params: { id: string } }) {
  ...
  const articleDetailedInfo = articles.find((article) => article.id === numericId);
        ...
        <div className="bg-white items-baseline flex flex-row flex-wrap xl:justify-evenly text-black">
          ...
          <div className=" flex flex-col md:max-w-[800px] md:h-screen px-5 py-5 gap-5">
            ...
            <div className="flex flex-col gap-5">
              ...
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores facilis in laborum. Consectetur
                corporis deserunt dolores iure, in eum cupiditate dolor nemo, reprehenderit doloribus tenetur illo porro
                omnis quo? Molestias illum facere fuga. Beatae accusamus magni, mollitia laudantium delectus dolorum!
                Unde debitis delectus eius dolorum, maiores nesciunt modi voluptatibus velit itaque impedit, dicta,
                fugit soluta dolore eaque cupiditate! <br />
                <br /> Neque sint a natus, aut iste repudiandae minus ab sit, porro, recusandae pariatur earum
                voluptatem quo. Minus vitae error eius non alias rem consectetur consequuntur accusantium iure laborum
                quo magnam iusto earum ducimus placeat culpa ipsum, repellendus ullam. Iste fugit sequi deserunt.
                Cupiditate eos labore quibusdam suscipit harum dolorem assumenda, aut ut nisi et quos tempora magni
                sapiente deleniti molestias, architecto ducimus illum consectetur ab officiis.
              </p>
            </div>
